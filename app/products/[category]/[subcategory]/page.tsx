...
export default function CategorySubcategoryPage() {
  ...
  const { products: apiProducts, isLoading, isError, total } = useProducts(mainCategoryId, categoryId, null, page, 10);

  // Set category info when main categories are loaded
  useEffect(() => {
    if (!mainCategorySlug || !categorySlug || mainCategories.length === 0) return;
  ...
  }, [mainCategorySlug, categorySlug, mainCategories]);
  ...
  useEffect(() => {
    if (mainCategoryId && categoryId && !selectedCategories.includes(categoryId)) {
      setSelectedCategories([categoryId]);
    }
  }, [mainCategoryId, categoryId, selectedCategories]);
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 py-8">
        {/* Breadcrumb */}
        <div className="mb-4 text-sm text-gray-600 px-2 md:px-0 overflow-x-auto whitespace-nowrap">
          <span>Home</span>
