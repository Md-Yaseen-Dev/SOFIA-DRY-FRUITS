      ...
      <div className="px-4 md:px-16 py-10 space-y-7">
        ...
        <div className="bg-[#FFEDD5] text-orange-400 text-center py-10 px-6 rounded-md">
          <p className="text-lg leading-relaxed max-w-5xl mx-auto">
            With the trendiest, freshest, and most unique styles from across India and the world, <strong>Shifa Nour</strong> invites you to express your personal style fearlessly — with confidence and optimism that can't be shaken.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-sm text-gray-800 font-semibold mb-2">
              Shifa Nour <span className="text-sm text-gray-600">Dry Fruits</span>
            </h2>
            <p className="text-gray-500">
              <strong>Shifa Nour <span className="text-xs font-semibold text-gray-500">Dry Fruits</span></strong> is our own private label – designed in-house for those who want one-of-a-kind,
          ...
          <div>
            ...
            <p className="text-gray-500">
              ...
              for what's in vogue. Shifa Rah brings it all directly to your wardrobe.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-gray-500 mb-7">
              For every mood, moment, or celebration — Shifa Nour brings you capsule collections that let your
              personality shine. Whether it's brunch with friends or a Diwali party, we've got your vibe covered.
            </p>
            <h3 className="text-sm text-gray-800 font-semibold mb-2">Shifa    Style Circle</h3>
            <p className="text-gray-500">
          ...
          <div>
            ...
            <h3 className="text-sm text-gray-800 font-semibold mb-2">Recommends Shifa Nour</h3>
            <p className="text-gray-500">
              A space where we celebrate our most stylish customers — those who've tagged us while flaunting their Shifa Nour fits.
        ...
        <div className="text-center mt-16 text-lg max-w-3xl mx-auto">
          <p className="text-gray-500 font-semibold">
            Shifa Nour is more than fashion — it's a platform for bold expression, individuality, and inclusivity.  
            Shop online at <a href="https://www.ShifaNour.in" className="text-orange-600">Shifa Nour.in</a> and discover how fashion meets freedom, comfort, and culture — all in one place.
          </p>
        </div>
      </div>
